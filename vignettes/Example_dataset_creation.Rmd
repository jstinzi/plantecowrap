---
title: "Example_dataset_creation"
author: "Joseph R. Stinziano"
date: "`r Sys.Date()`"
output: rmarkdown::html_document
vignette: >
 %\VignetteIndexEntry{Example_dataset_creation}
 %\VignetteEngine{knitr::rmarkdown}
 %\VignetteEncoding{UTF-8}
---
This code is used to generate the example datasets for the package.
```{r}
...
#Uncomment below to create the files in your working directory
#write.csv(data, "example_1.csv")
#write.csv(data2, "example_2.csv")
```
